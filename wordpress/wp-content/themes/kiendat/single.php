                  ...
                  <div class="col-md-12">
                    <div class="recommend">
                      <div class="title">The Best Of Travel</div>
                       <?php 
                          query_posts(array('category_name' => 'best-of-travel','posts_per_page' => 3));
                          while (have_posts()) : the_post();
                        ?>
                        <div class="col-md-4 post-item">
                          <?php the_post_thumbnail('img-post-sidebar'); ?>
                          <a href="<?php the_permalink(); ?>"><h2><?php echo _substr(get_the_title(), 100); ?></h2></a>
                        </div>
                        <?php 
                          endwhile;
                          wp_reset_query();
